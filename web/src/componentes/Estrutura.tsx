 ...
 * e não "isto é mais um site de vendas". O sinal fica reservado para a
      ...
      <div className="max-w-6xl mx-auto px-4 pb-10 grid gap-8 sm:grid-cols-3 text-sm">
        <div>
          <div className="flex items-center gap-2 text-sinal mb-2">
            <Arco />
            <span className="font-display text-lg font-bold text-chapa">Vitrine Bauru</span>
          </div>
          <p className="text-fundo/80 leading-relaxed">
