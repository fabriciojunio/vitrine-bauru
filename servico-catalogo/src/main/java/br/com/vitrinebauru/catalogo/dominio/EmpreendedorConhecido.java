...
/**
 * O que o catálogo sabe sobre um empreendedor, aprendido por evento.
 *
 * <p>O catálogo precisa responder duas perguntas antes de aceitar um produto:
 * este empreendedor existe, e ele pode publicar. Perguntar isso ao serviço de
 * cadastro a cada produto salvo faria os dois serviços caírem juntos e
 * transformaria a separação em enfeite. Guardando aqui o pouco que interessa,
 * o catálogo continua de pe mesmo com o cadastro fora do ar.
 *
 * <p>Não há documento, e-mail nem telefone nesta cópia. Replicar dado pessoal
 * por comodidade é o jeito mais comum de espalhar informação sensível por
 * bancos que ninguém lembra de limpar depois.
 */
@Entity
